...
(
	...
	MaKH    varchar(10) constraint HD_KH foreign key references KHACHHANG(MaKH) not null,
    MaNV    varchar(10) constraint HD_NV foreign key references NHANVIEN(MaNV) not null,
)
go
...
(
	...
	VAT                numeric(15,0) not null, --VAT = 10% tổng tiền hàng
    TongTienTT        numeric(15,0) not null, --tổng tiền thanh toán = tổng tiền hàng - VAT
	MaNCC            varchar(10) constraint PN_NCC foreign key references NHACUNGCAP(MaNCC) not null,
	MaNV           varchar(10) constraint PN_NV foreign key  references NHANVIEN(MaNV) not null,
)
go
